...
import { createEventThunkCreator } from '../../../reducers/administrationReducer';
        ...
        if (selectedFile != null) {
            ...
            if (!validateFields()) {
                ...
                if (dateTimeFrom > dateTimeTo) {
                    ...
                    const result = await dispatch(createEventThunkCreator(title, description, digesText, pictureId.id, isTimeFromNeeded, dateFrom,
                        isTimeToNeeded, dateTo, link, addressName, latitude, longitude, isRegistrationRequired, registrationLastDate,
                        isDigestNeeded, notificationText, type, format, auditory));

                    if (result) {
                        const message = t('eventCreated');
                        ...
                        setNotification({ message: t('failedCreateEvent'), type: 'Error', show: true });
                    }
                }
            }
        }
            ...
            if (!validateFields()) {
                ...
                if (dateTimeFrom > dateTimeTo) {
                    ...
                    const result = await dispatch(createEventThunkCreator(title, description, digesText, null, isTimeFromNeeded, dateFrom,
                        isTimeToNeeded, dateTo, link, addressName, latitude, longitude, isRegistrationRequired, registrationLastDate,
                        isDigestNeeded, notificationText, type, format, auditory));
    ...
    return (
        <div className={styles.createEventContainer}>
            ...
            <div className={styles.links}>
                ...
                <span className={styles.linkPage2}>{t('eventCreation')}</span>
            </div>
            <div className={styles.createEventInformation}>
                <div>
                    <span className={styles.header}>{t('eventCreation')}</span>
                </div>
                <div className={styles.content}>
                    ...
                    <div className={styles.files}>
                        ...
                        <div >
                            <div onClick={handleButtonClick} className={styles.formFiles}>
                    ...
                    <div className={styles.buttons}>
                        <button className={styles.buttonSave} onClick={createEvent}>{t('save')}</button>
